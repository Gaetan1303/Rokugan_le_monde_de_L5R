...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.password = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _password_initializers, void 0)); // Store hashed password only
            this.role = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _role_initializers, void 0)); // "GM" ou "joueur"
    ...
    (() => {
        ...
        _password_decorators = [Column({ length: 255 })];
